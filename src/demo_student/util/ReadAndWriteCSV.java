package demo_student.util;

import demo_student.models.Instructor;
import demo_student.models.Student;
...
public class ReadAndWriteCSV {
    static final String EMPLOYEE_FILE ="src/demo_student/data/Intructor.csv";
    static final String STUDENT_FILE ="src/demo_student/data/Student.csv";
